...
export default function ALPRSpotlight() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: css.bg, fontFamily: css.mono, color: css.textMid }}>
            ...
            <div style={{ padding: "20px 22px", maxHeight: "55vh", overflowY: "auto" }}>
              ...
              {[
                ...
                },
                {
                  icon: "🔒",
                  title: "Data Usage",
                  text: "This tool transmits your selected location coordinates to a backend service solely to identify nearby law enforcement agencies. No location data is stored or logged. Your name, email address, and request letter content are never transmitted through this tool as all email sending occurs directly through your own email client. Source code is available at: https://github.com/EmberDrift/alpr-spotlight-frontend"
                },
                {
                  icon: "🚫",
      ...
      {disclaimerAccepted && (
        <div style={{
          background: "#080c14", borderBottom: `1px solid ${css.border}`,
          ...
          {[
            ...
            <button
              ...
              style={{
                background: "transparent", border: `1px solid ${color}33`, borderRadius: 3,
                color, padding: "3px 8px", cursor: "pointer", fontSize: 9,
                letterSpacing: "0.12em", display: "flex", alignItems: "center",
                gap: 4, position: "relative", flexShrink: 0, whiteSpace: "nowrap"
              }}
            >
              ▣ {label}
              <span id={`copied-${label}`} style={{
                position: "fixed", top: 38, left: "50%", transform: "translateX(-50%)", zIndex: 99999,
                background: css.card, border: `1px solid ${css.border}`, borderRadius: 3,
                padding: "2px 6px", fontSize: 8, color: css.green, whiteSpace: "nowrap",
                opacity: 0, transition: "opacity 0.15s", pointerEvents: "none"
              }}>copied</span>
            </button>
          ))}
          <div style={{ width: 1, height: 14, background: css.border, flexShrink: 0, margin: "0 2px" }} />
          <a href="https://ko-fi.com/emberdrift" target="_blank" rel="noopener noreferrer" style={{
            background: "transparent", border: "1px solid #ff5e5b33", borderRadius: 3,
            color: "#ff5e5b", padding: "3px 8px", fontSize: 9, flexShrink: 0,
            textDecoration: "none", letterSpacing: "0.12em", whiteSpace: "nowrap"
          }}>☕ Ko-fi</a>
        </div>
      )}
